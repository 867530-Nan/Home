...
u = User.create_with(password: "Testtest123", password_confirmation: "Testtest123", name: "Matthew Peterson").find_or_initialize_by(email: email_address)
...
e = Employee.create(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, phone_number: "8015555555", email_address: email_address)
u = User.create_with(password: "Testtest123", password_confirmation: "Testtest123", name: "Harry Plumer").find_or_initialize_by(email: email_address)
u.save(validate: false)
EmployeeJob.create(employee: e, job: j, pay_rate: 100000)
...
e = Employee.create(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, phone_number: "8015555555", email_address: email_address)
u = User.create_with(password: "Testtest123", password_confirmation: "Testtest123", name: "Von van Bergen").find_or_initialize_by(email: email_address)
u.save(validate: false)
